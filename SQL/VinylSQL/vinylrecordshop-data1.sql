...
INSERT INTO album (albumTitle, releaseDate, price, label) 
	VALUES	("No One's Gonna Change Our World", '1969-12-12', 39.95, 'Regal Starline'),
...
##Commented out as we add data through dumps after initial import
##artist
...
#        FIELDS TERMINATED BY ',';
###bandartist
#LOAD DATA INFILE 'albumC:/Users/cjusm/Documents/MThree Java Course/MThree-Java-Classwork/SQL/VinylSQL/artistBand.csv'
...
INSERT INTO `band`
  VALUES (1, 'The Beatles\r'), (2, 'Zager and Evans\r'),
         (3, 'Van Morrison\r'), (4, 'Judy Collins\r'),
         (5, 'Simon and Garfunkel\r'), (7, 'Beach Boys\r'),
         (8, 'Led Zeppelin\r');

##insert mysql dump from song using csv import
INSERT INTO `song`
  VALUES
...
##insert mysql dump from artistBand using csv import
INSERT INTO `bandartist`
  VALUES (1,1), (1,2), (1,3), (1,4), (2,5), (2,6), (3,10),
         (4,11), (5,12), (5,13), (7,14), (7,15), (7,16),
         (7,17), (7,18), (7,23), (7,24), (7,25), (7,26),
         (8,19), (8,20), (8,21), (8,22);

##insert mysql dump from songAlbum using csv import
